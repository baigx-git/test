...
import com.luxondata.test.common.enums.MessageEnums;
import com.luxondata.test.common.enums.MsgActionEnum;
import com.luxondata.test.dto.PushMessageData;
import com.luxondata.test.dto.UserWebsocketSalt;
import com.luxondata.test.util.JsonUtil;
import com.luxondata.test.util.UserChannelRelation;
import com.luxondata.test.vo.WsDataContent;
...
public class NoMaybeHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    ...
    protected void channelRead0(ChannelHandlerContext channelHandlerContext, TextWebSocketFrame textWebSocketFrame) throws Exception {
        ...
        try {
            //将消息转换成pojo
            WsDataContent wsDataContent = JsonUtil.JSONToObj(content, WsDataContent.class);
...
//                    }
    ...
    public static void writeAndFlushResponse(Integer action, String msgId, Object data, Channel channel) {
        ...
        channel.writeAndFlush(new TextWebSocketFrame(JsonUtil.objectToJson(wsDataContent)));
    }
    ...
    public static PushMessageData createKickMsgBody() {
        ...
        pushMessageData.setMsgType(MessageEnums.ClientMsgTp.getId());
        pushMessageData.setMsgVariety(MessageEnums.ClientMsgTp.getCode());
        pushMessageData.setTime(LocalDateTime.now());
